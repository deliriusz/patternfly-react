...
const ConnectorSquare = ({ startPoint, endPoint, className = '', isTarget = true, size = 14, dragRef }) => {
    ...
    const classNames = react_styles_1.css(topology_components_1.default.topologyConnectorArrow, topology_components_1.default.topologyConnectorSquare, !isTarget && topology_components_1.default.modifiers.source, className, dragRef && 'pf-m-draggable');
