...
const groupDropTargetSpec = {
    ...
    canDrop: (item, monitor) => {
        var _a;
        return monitor.isOver({ shallow: monitor.getItemType() === CREATE_CONNECTOR_DROP_TYPE }) &&
            (((_a = monitor.getOperation()) === null || _a === void 0 ? void 0 : _a.type) === REGROUP_OPERATION || monitor.getItemType() === CREATE_CONNECTOR_DROP_TYPE);
    },
    collect: monitor => {
        var _a, _b, _c;
        return ({
            ...
            canDrop: monitor.isDragging() &&
                (((_b = monitor.getOperation()) === null || _b === void 0 ? void 0 : _b.type) === REGROUP_OPERATION || monitor.getItemType() === CREATE_CONNECTOR_DROP_TYPE),
